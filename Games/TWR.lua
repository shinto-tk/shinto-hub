...
local function GetHitbox(Config)
    ...
    for Index,NPC in pairs(NPCFolder:GetChildren()) do
        for Index,BodyPart in pairs(Config.BodyParts) do
            ...
            if DistanceCheck(Config.Distance.Enabled,Distance,Config.Distance.Value) and WallCheck(Config.WallCheck,Hitbox,NPC) then
...
for Index,NPC in pairs(NPCFolder:GetChildren()) do
    Shinto.Utilities.Drawing:AddESP(NPC,"NPC","ESP/NPC",Window.Flags)
end
NPCFolder.ChildAdded:Connect(function(NPC)
    Shinto.Utilities.Drawing:AddESP(NPC,"NPC","ESP/NPC",Window.Flags)
end)
NPCFolder.ChildRemoved:Connect(function(NPC)
    Shinto.Utilities.Drawing:RemoveESP(NPC)
end)
